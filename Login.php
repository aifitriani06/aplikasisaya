                                    ...
                                    <div class="card-body">
                                    	<?php 
                                    		if (isset($_POST['login'])) {
                                    				...
                                    				if ($cek > 0 ) {
                                    					...
                                    					echo '<script>alert("Maaf, Username/Password salah"); location.href="index.php";</script>';
                                    				}
                                        ...
                                        <form method="post">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="inputusername" type="text" name="username" placeholder="Masukan username Anda" />
